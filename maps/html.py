...
def make_html(flights, airports):
    ...
    with tag('html'):
        with tag('head'):
            ...
            doc.asis('<link href="https://fonts.googleapis.com/css2?family=Geologica:wght@100..900&display=swap" rel="stylesheet">')
            doc.asis('<link href="https://fonts.googleapis.com/css2?family=Vollkorn:ital,wght@0,400..900;1,400..900&display=swap" rel="stylesheet">')
